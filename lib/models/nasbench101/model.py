...
from models.nasbench101.base_ops import *
from models.nasbench101.model_spec import ModelSpec
...
class Network(nn.Module):
    def __init__(self, spec, num_labels=10,
                 in_channels=3, stem_out_channels=128, num_stacks=3, num_modules_per_stack=3, use_stem=True):
        """
...
class Cell(nn.Module):
    ...
    def __init__(self, spec, in_channels, out_channels):
        ...
        # print(f'vertex chn: {self.vertex_channels}')
