...
class TinyNetwork(nn.Module):
    ...
    def __init__(self, C, N, genotype, num_classes, C_in=3, depth=-1):
        ...
        self.stem = nn.Sequential(
                                        nn.Conv2d(C_in, C, kernel_size=3, padding=1, bias=False),
                                        nn.BatchNorm2d(C))
    ...
    #     if channel == 1:
    #         feature = self.cell_thin_1(inputs)
    #     if channel == 2:
    #         feature = self.cell_thin_2(inputs)
    #     if channel == 3:
    #         feature = self.cell_thin_3(inputs)
    #     # feature = self.stem_thin(inputs)
    ...
    def forward(self, inputs, return_features=False):
        ...
        features.append(out)  # 18
        out = self.global_pooling(out)
        features.append(out)  # 19
